...
if(string.IsNullOrEmpty(AppConfigEndPoint)) // La deuxi�me partie est pour recevoir l'information a partir du ACI
...
app.MapPost("/Comments/Add", async (CommentCreateDTO commentDTO, IRepositoryAPI repo, ServiceBusController sb) =>
{
    ...
    // Ceci pourrait �tre bouger dans le Worker_DB ou laisser ici ...
    if (Result.Result is Accepted)
    {
